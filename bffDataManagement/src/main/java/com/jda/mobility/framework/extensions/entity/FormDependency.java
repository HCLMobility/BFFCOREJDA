...
@Entity
@Table(name="FORM_DEPENDENCY")
@NamedQuery(name="FormDependency.findAll", query="SELECT f FROM FormDependency f")
public class FormDependency implements Serializable {
